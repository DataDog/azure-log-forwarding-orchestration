...
## Usage
This skill deploys your personal Azure environment for testing the log forwarder. It creates all necessary resources and configures them properly.
...
## Parameters
- `DEPLOYMENT_TYPE`: Choose vm, container-app, or both (default: vm)
- `LFO_VM_BASE_NAME`: Override base name (default: lfo<username>vm)
...
DEPLOYMENT_TYPE="${DEPLOYMENT_TYPE:-vm}"
...
echo ""
echo "🎯 Next Steps:"
echo "1. Run 'discover-environment' skill to see your resources"
echo "2. Run 'generate-test-logs' skill to create test data"
echo "3. Run 'forwarder-status' skill to check processing"
...
DEPLOYMENT_TYPE=vm ./deploy-personal-env.md

# Deploy container app version
DEPLOYMENT_TYPE=container-app ./deploy-personal-env.md

# Deploy both
DEPLOYMENT_TYPE=both ./deploy-personal-env.md

# Use custom base name
LFO_VM_BASE_NAME="mytestenv" ./deploy-personal-env.md
```
