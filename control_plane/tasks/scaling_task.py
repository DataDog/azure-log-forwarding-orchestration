...
class ScalingTask(Task):
    ...
    def __init__(self, resource_cache_state: str, assignment_cache_state: str, wait: bool = False) -> None:
        super().__init__()
    ...
    async def create_log_forwarder_env(self, client: LogForwarderClient, region: str) -> None:
        ...
        try:
            await client.create_log_forwarder_managed_environment(region, wait=self.wait)
        except Exception:
