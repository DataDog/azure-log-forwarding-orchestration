...
const (
	...
	AzureWebJobsStorageAccountName = "AzureWebJobsStorage__accountName"
	AzureWebJobsStorageClientID    = "AzureWebJobsStorage__clientId"
	AzureWebJobsStorageCredential  = "AzureWebJobsStorage__credential"
